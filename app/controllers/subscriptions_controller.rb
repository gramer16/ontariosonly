class SubscriptionsController < ApplicationController
  ...
  private
    ...
    def subscription_params
      params.require(:subscription).permit(:email, :name, :description, :stripe_card_token, :company_name, :website, :address, :zipcode, :city, :phone, :contact, :company_email, :sellerid, :card_name, :bill_address, :image)
    end
